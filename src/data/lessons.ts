    ...
    // =========================================================================
    {
        ...
        content: {
            pairs: [
                ...
                { word: "color", translation: "צבע / לצבוע", context: "Pick a nice color.", contextTranslation: "בחר צבע יפה." },
                { word: "paint", translation: "צבע / לצבוע", context: "Paint the walls red.", contextTranslation: "צבע את הקירות באדום." },
